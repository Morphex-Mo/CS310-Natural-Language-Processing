...
| tokenizer | vocab_size | accuracy | precision | recall | f1 | loss |
|---|---:|---:|---:|---:|---:|---:|
| basic_char | 2687 | 0.7312 | 0.4706 | 0.2353 | 0.3137 | 0.5587 |
| advanced | 7345 | 0.7066 | 0.4305 | 0.3824 | 0.4050 | 0.6854 |
...
4. `basic_char` 的策略更保守，负类判定更稳定，因此准确率较高，但对正类样本的覆盖相对不足。
